...
if(!defined("_RAPIDO_AUTOLOAD")){
    define("_RAPIDO_AUTOLOAD", true);

    if(!defined("_RAPIDO_AUTOLOAD_DIR")){
        define("_RAPIDO_AUTOLOAD_DIR", dirname(__FILE__)."");
    }
    ...
    spl_autoload_register(function($class) {
        $file = _RAPIDO_AUTOLOAD_DIR."/".str_replace('\\', '/', $class).'.php';
        if(file_exists($file)){
            require $file;
        } else {
